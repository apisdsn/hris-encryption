...
-- FUNCTION TRIGGER ENCRYPTION EMPLOYEE SYMMETRIC ALGORITHM BLOWFISH
...
DECLARE
    ...
    options TEXT := 'compress-algo=0, cipher-algo=bf, unicode-mode=1';
BEGIN
...
-- CREATE TRIGGER ENCRYPTION BEFORE INSERT OR UPDATE FOR TABLE EMPLOYEE SYMMETRIC ALGORITHM BLOWFISH
CREATE TRIGGER trigger_encrypt_data_sym_employee_algo_bf
...
DROP TRIGGER trigger_encrypt_data_sym_employee_algo_bf ON employee;

DROP FUNCTION decrypt_employee_data(BYTEA, BYTEA, BYTEA, BYTEA);

-- FUNCTION DECRYPTION EMPLOYEE FOR SYMMETRIC ALGORITHM BLOWFISH
